...
t(contains(t.markerlabel,"StartRecord") | contains(t.markerlabel,"StopRecord") | contains(t.markerlabel,"NLXEvent") | contains(t.markerlabel,"BAD"),:) = [];
...
print(h, '-dpdf', fullfile(config.imagesavedir,'overview_segmentation.pdf'),'-r600');
