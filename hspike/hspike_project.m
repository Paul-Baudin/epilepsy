...
%     [MuseStruct_micro, MuseStruct_macro] = MuseMarkers_update_filepath_parts(config{ipatient},MuseStruct_micro, MuseStruct_macro);
    ...
    dat_macro_avg = ft_timelockanalysis([],dat_macro_append);
    ...
    cfgtemp.toi                     = config{ipatient}.epoch.toi{1}(1):0.05: config{ipatient}.epoch.toi{1}(2);
    TFR_micro                       = ft_freqanalysis(cfgtemp,dat_micro_append);
